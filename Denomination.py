...
def topwin():
    ...
    def calculator():
        try:
            global amount
            amount = int(entry.get())#34800
            note2000 = amount // 2000  #34800//2000=17
            amount %= 2000 #34800/2000=> 800
            note500 = amount // 500  # 800//500=1
            amount %= 500   #800/500 =300
            note100 = amount // 100  # 300//100 =3
